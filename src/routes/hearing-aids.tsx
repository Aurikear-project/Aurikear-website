      ...
      <Section>
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-5 leading-relaxed text-mid">
            No two people experience hearing loss in exactly the same way.
            Your hearing aids should reflect not only your hearing, but also
            your lifestyle, preferences and the situations in which you want
            to hear better.
          </p>
        ...
        <div className="mt-24">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 leading-relaxed text-mid">
              We work with Oticon and Phonak, giving you access to a broad
              range of modern hearing solutions for different hearing and
              lifestyle needs.
            </p>
          </div>
          ...
          <div className="mt-12 grid items-center gap-10 rounded-3xl border border-border bg-sky-pale/50 p-7 md:grid-cols-2 md:gap-14 md:p-12">
            <div>
              ...
              <p className="mt-4 leading-relaxed text-mid">
                ...
                including discreet receiver-in-the-ear devices, custom
                hearing aids and behind-the-ear technology.
              </p>
              <p className="mt-3 leading-relaxed text-mid">
                We'll help you understand which Oticon technology and style
                is appropriate for your hearing, listening needs and
                preferences.
              </p>
        ...
        <div className="mt-24 rounded-3xl bg-primary-deep px-7 py-12 text-white md:px-12 md:py-16">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl leading-relaxed text-foam/80">
              ...
              based on your individual assessment rather than expecting you
        ...
        <div className="mt-20 rounded-2xl border border-border bg-sky-pale p-8 md:p-12">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-3">
            {[
              ...
              <div
                key={item.level}
                className="rounded-xl border border-border bg-white p-5 shadow-border"
              >
        ...
        <div className="mt-12 rounded-2xl bg-primary-deep px-6 py-12 text-center text-white md:px-12">
          ...
          <p className="mx-auto mt-3 max-w-lg text-foam/80">
            Arrange a comprehensive hearing assessment and discuss the
            hearing technology that best suits your individual needs.
          </p>
